...
public class WebSocketServerHandshakerFactory {
    ...
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(WebSocketServerHandshakerFactory.class);
    ...
    public WebSocketServerHandshaker newHandshaker(HttpRequest req) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug(String.format("newHandshker, request headers: ", req.getHeaders()));
        }
